// Images specifically for the home page carousel
...
// Gallery collections organized by theme or location
export const galleryCollections = [
  {
    id: 'urban-streets',
    title: 'Urban Streets',
    description: 'Street photography from city life',
    images: [
  ...
  },
  {
    ...
    description: 'Natural beauty and scenic views',
    images: [
...
// Helper function to get all images from all collections (for backwards compatibility)
export function getAllGalleryImages() {
  return galleryCollections.flatMap(collection => collection.images);
}